    ...
    <PageLayout>
      <div className="min-h-screen bg-black flex items-center justify-center px-4 sm:px-6 lg:px-8 py-20">
        <div className="w-full max-w-md">
            ...
            <div className="bg-gray-900/70 backdrop-blur-md border border-gray-800 rounded-2xl p-8 shadow-xl">
              ...
              >
                <p className="text-gray-400 text-sm">
                  ...
                  <Link href="/signup" className="text-gray-300 hover:text-white font-medium transition-colors">
                    Sign up
                  </Link>
                </p>
              </motion.div>
          ...
          {/* Decorative elements */}
          <motion.div 
            className="absolute top-20 right-10 w-20 h-20 rounded-full bg-purple-500/10 blur-3xl" 
            animate={{ 
              scale: [1, 1.2, 1],
              opacity: [0.3, 0.5, 0.3]
            }}
          ...
          />
          <motion.div 
            className="absolute bottom-20 left-10 w-20 h-20 rounded-full bg-blue-500/10 blur-3xl" 
            animate={{ 
              scale: [1, 1.5, 1],
              opacity: [0.3, 0.6, 0.3]
            }}
